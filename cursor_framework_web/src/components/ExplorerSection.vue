...
const rules: RuleItem[] = [
  { id: 'r1', name: 'skill-registry.mdc', domain: 'core', tags: ['skills', 'registry'], icon: 'layers' },
  { id: 'r2', name: 'skill-integration.mdc', domain: 'core', tags: ['skills', 'auto-discovery'], icon: 'grid' },
  { id: 'r3', name: 'context-router.mdc', domain: 'core', tags: ['routing', 'intelligence'], icon: 'search' },
  { id: 'r4', name: 'task-analyzer.mdc', domain: 'core', tags: ['task', 'analysis'], icon: 'code' },
  { id: 'r5', name: 'coding-standards.mdc', domain: 'core', tags: ['code', 'conventions'], icon: 'code' },
  { id: 'r6', name: 'frontend-frameworks.mdc', domain: 'frontend', tags: ['next.js', 'vue', 'nuxt'], icon: 'monitor' },
  { id: 'r7', name: 'ui-visual-design.mdc', domain: 'frontend', tags: ['design', 'ui'], icon: 'monitor' },
  { id: 'r8', name: 'backend-frameworks.mdc', domain: 'backend', tags: ['nestjs', 'laravel', '.net'], icon: 'server' },
  { id: 'r9', name: 'databases.mdc', domain: 'database', tags: ['postgres', 'mysql', 'rls'], icon: 'database' },
  { id: 'r10', name: 'redis.mdc', domain: 'database', tags: ['redis', 'cache'], icon: 'database' },
  { id: 'r11', name: 'supabase.mdc', domain: 'database', tags: ['supabase', 'rls', 'baas'], icon: 'database' },
  { id: 'r12', name: 'auth.mdc', domain: 'security', tags: ['auth', 'jwt', 'oauth'], icon: 'shield' },
  { id: 'r13', name: 'security.mdc', domain: 'security', tags: ['security', 'best-practices'], icon: 'shield' },
  { id: 'r14', name: 'performance.mdc', domain: 'devops', tags: ['performance', 'rate-limit'], icon: 'cloud' },
  { id: 'r15', name: 'cost-optimization.mdc', domain: 'devops', tags: ['cost', 'tokens'], icon: 'cloud' },
  { id: 'r16', name: 'deployment.mdc', domain: 'devops', tags: ['ci-cd', 'deploy'], icon: 'cloud' },
  { id: 'r17', name: 'container-orchestration.mdc', domain: 'devops', tags: ['docker', 'k8s'], icon: 'cloud' },
  { id: 'r18', name: 'observability.mdc', domain: 'devops', tags: ['monitoring', 'logging'], icon: 'cloud' },
  { id: 'r19', name: 'operations.mdc', domain: 'devops', tags: ['alerting', 'incidents'], icon: 'cloud' },
  { id: 'r20', name: 'version-control.mdc', domain: 'devops', tags: ['git', 'github'], icon: 'cloud' },
  { id: 'r21', name: 'testing.mdc', domain: 'devops', tags: ['unit', 'integration', 'e2e'], icon: 'cloud' },
  { id: 'r22', name: 'llm-providers.mdc', domain: 'ai', tags: ['openai', 'claude', 'gemini'], icon: 'bot' },
  { id: 'r23', name: 'ai-knowledge.mdc', domain: 'ai', tags: ['rag', 'vector-search'], icon: 'bot' },
  { id: 'r24', name: 'cloud-providers.mdc', domain: 'cloud', tags: ['aws', 'azure', 'gcp'], icon: 'cloud' },
  { id: 'r25', name: 'cloud-infra.mdc', domain: 'cloud', tags: ['infrastructure'], icon: 'cloud' },
  { id: 'r26', name: 'cloudflare.mdc', domain: 'cloud', tags: ['cloudflare', 'cdn'], icon: 'cloud' },
  { id: 'r27', name: 'serverless.mdc', domain: 'cloud', tags: ['serverless', 'iac'], icon: 'cloud' },
  { id: 'r28', name: 'api-patterns.mdc', domain: 'cloud', tags: ['rest', 'graphql', 'gateway'], icon: 'cloud' },
  { id: 'r29', name: 'billing.mdc', domain: 'business', tags: ['billing', 'subscription'], icon: 'creditcard' },
  { id: 'r30', name: 'crm-saas.mdc', domain: 'business', tags: ['crm', 'saas'], icon: 'users' },
  { id: 'r31', name: 'multi-tenant.mdc', domain: 'business', tags: ['multi-tenant', 'isolation'], icon: 'users' },
  { id: 'r32', name: 'workflow-engines.mdc', domain: 'business', tags: ['n8n', 'temporal'], icon: 'users' },
  { id: 'r33', name: 'architecture-patterns.mdc', domain: 'architecture', tags: ['clean', 'hexagonal', 'cqrs'], icon: 'layers' },
  { id: 'r34', name: 'enterprise-patterns.mdc', domain: 'architecture', tags: ['monolith', 'microservices'], icon: 'layers' },
  { id: 'r35', name: 'memory-first.mdc', domain: 'core', tags: ['memory', 'context'], icon: 'code' },
  { id: 'r36', name: 'intent-detection.mdc', domain: 'core', tags: ['intent', 'nlp'], icon: 'code' },
  { id: 'r37', name: 'vibe-code-protocol.mdc', domain: 'core', tags: ['protocol', 'vibe'], icon: 'code' },
  { id: 'r38', name: 'multi-language-processing.mdc', domain: 'core', tags: ['i18n', 'translation'], icon: 'code' },
  { id: 'r39', name: 'multi-language-vibe-code.mdc', domain: 'core', tags: ['i18n', 'vibe'], icon: 'code' },
]

const skills: SkillItem[] = [
  { id: 's1', name: 'frontend-taste', platform: 'Cursor · Claude', initials: 'FT', category: 'frontend' },
  { id: 's2', name: 'frontend-redesign', platform: 'Cursor · Claude', initials: 'FR', category: 'frontend' },
  { id: 's3', name: 'frontend-review', platform: 'Cursor · Claude', initials: 'FV', category: 'frontend' },
  { id: 's4', name: 'security-review', platform: 'Cursor · Claude', initials: 'SR', category: 'security' },
  { id: 's5', name: 'full-output', platform: 'Cursor · Claude', initials: 'FO', category: 'utility' },
  { id: 's6', name: 'karpathy-coding', platform: 'Cursor · Claude', initials: 'KC', category: 'core' },
  { id: 's7', name: 'ponytail', platform: 'Cursor · Claude', initials: 'PT', category: 'core' },
  { id: 's8', name: 'visual-explainer', platform: 'Cursor · Claude', initials: 'VE', category: 'utility' },
  { id: 's9', name: 'open-design', platform: 'Cursor · Claude', initials: 'OD', category: 'design' },
  { id: 's10', name: 'document-ocr', platform: 'Cursor · Claude', initials: 'OC', category: 'utility' },
  { id: 's11', name: 'bazi', platform: 'Cursor · Claude', initials: 'BZ', category: 'business' },
  { id: 's12', name: 'vietnam-payment-review', platform: 'Cursor · Claude', initials: 'VP', category: 'business' },
  { id: 's13', name: 'vietnam-address', platform: 'Cursor · Claude', initials: 'VA', category: 'business' },
  { id: 's14', name: 'weknora-kb', platform: 'Cursor · Claude', initials: 'WK', category: 'ai' },
  { id: 's15', name: 'weknora-agent', platform: 'Cursor · Claude', initials: 'WA', category: 'ai' },
  { id: 's16', name: 'pixelrag', platform: 'Cursor · Claude', initials: 'PR', category: 'ai' },
  { id: 's17', name: 'skill-installer', platform: 'Cursor · Claude', initials: 'SI', category: 'utility' },
  { id: 's18', name: 'skill-extension', platform: 'Cursor · Claude', initials: 'EX', category: 'utility' },
]
