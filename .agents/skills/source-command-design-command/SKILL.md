---
name: "source-command-design-command"
description: "Migrated source command `design-command`"
---

# source-command-design-command

Use this skill when the user asks to run the migrated source command `design-command`.
