---
name: "source-command-scrape-command"
description: "Migrated source command `scrape-command`"
---

# source-command-scrape-command

Use this skill when the user asks to run the migrated source command `scrape-command`.
