...
- Blow past Codex's skill-loading budget per request
...
|---|---|---|---|---|
| `frontend-taste` (this file) | `.cursor/skills/ui_ui_frontend-taste/SKILL.md` | Build landing pages, portfolios, redesigns | §0 pre-flight | §6 audit + §10 polish review |
| `frontend-review` | `.cursor/skills/ui_ui_frontend-review/SKILL.md` | Quality gate for any frontend task | Part A scope | Part B 7-axis review |
| `frontend-redesign` | `.cursor/skills/ui_ui_frontend-redesign/SKILL.md` | Upgrade existing sites without breaking functionality | §0 pre-audit | §4 post-redesign audit |
| `karpathy-coding` | `.cursor/skills/code_karpathy/SKILL.md` | Overlay: pre/post reasoning gate for any code task | karpathy-pre | karpathy-post |
| `full-output` | `.cursor/skills/code_code_full-output/SKILL.md` | Multi-file implementations | fulloutput-pre | fulloutput-post |
| `ponytail` | `.cursor/skills/code_code_ponytail/SKILL.md` | Lazy Senior Dev — minimum viable code | ponytail-pre | ponytail-post |
| `Hallmark` | `.cursor/skills/ui_ui_frontend-taste/SKILL.md §9.A` | Anti-slop themes + 57 gates | theme selection | slop-test gates |
...
- Multiply the per-request context load (Codex loads each skill's body into context on relevant requests)
